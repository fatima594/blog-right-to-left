...
class ImageService extends ImageToolsService
{
    ...
    public function save($image)
    {
        ...
        // تحديد المسار الكامل
        $path = storage_path('app/public/posts/' . $this->finalImageName);

        // save image
        $result = Image::make($image->getRealPath())->save($path, null, $this->getImageFormat());

        return $result ? $this->getImageAddress() : false; // إرجاع المسار النسبي
    }
